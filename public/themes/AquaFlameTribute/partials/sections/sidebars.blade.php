    <div id="sidebar_content" class="clearfix">
        <section class="advertisement">
            <img src="{{ env('APP_URL')}}/themes/{{ config('theme.themeDefault') }}/assets/images/test/advertisement.png" alt="">
        </section>
        ...
        <section class="ssotd">
            ...
            <div class="content">
                <div class="ssotd-thumb">
                    <img src="" alt="" style="background-image: url({{ env('APP_URL')}}/themes/{{ config('theme.themeDefault') }}/assets/images/test/screenshot.png);">
                    <div class="options">
